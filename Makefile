#############################################################################
# Makefile for building: soe
# Generated by qmake (2.01a) (Qt 4.7.2) on: ? 6? 7 00:23:30 2011
# Project:  soe.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile soe.pro
#############################################################################
...
Makefile: soe.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/g++-multilib.conf \
		/usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/qconfig.pri \
		/usr/lib64/qt4/mkspecs/modules/qt_webkit_version.pri \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/soe1.0.0 || $(MKDIR) .tmp/soe1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/soe1.0.0/ && $(COPY_FILE) --parents soeditor.h .tmp/soe1.0.0/ && $(COPY_FILE) --parents main.cpp MainWindow.cpp SOEKeyBind.cpp sotextedit.cpp Widget.cpp .tmp/soe1.0.0/ && (cd `dirname .tmp/soe1.0.0` && $(TAR) soe1.0.0.tar soe1.0.0 && $(COMPRESS) soe1.0.0.tar) && $(MOVE) `dirname .tmp/soe1.0.0`/soe1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/soe1.0.0
...
moc_soeditor.cpp: soeditor.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) soeditor.h -o moc_soeditor.cpp
